      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={logout}
              className="px-5 py-4 rounded-2xl border border-gray-200 text-gray-400 hover:text-gray-700 hover:border-gray-300 transition-all font-black text-[11px] uppercase tracking-widest"
            >
              Sign Out
            </button>
          </div>
